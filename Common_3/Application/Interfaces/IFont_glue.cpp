...
extern "C" void _1_cmdDrawTextWithFont_(Cmd * pCmd, float2 screenCoordsInPx, const FontDrawDesc * pDrawDesc) { ::cmdDrawTextWithFont(pCmd, screenCoordsInPx, pDrawDesc); }
extern "C" void _1_cmdDrawWorldSpaceTextWithFont_(Cmd * pCmd, const mat4 * pMatWorld, const CameraMatrix * pMatProjView, const FontDrawDesc * pDrawDesc) { ::cmdDrawWorldSpaceTextWithFont(pCmd, pMatWorld, pMatProjView, pDrawDesc); }
...
extern "C" float2 _1_fntMeasureFontText_(const char * pText, const FontDrawDesc * pDrawDesc) { return ::fntMeasureFontText(pText, pDrawDesc); }
