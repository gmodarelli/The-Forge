...
extern "C" void _1_initRendererContext_(const char * appName, const RendererContextDesc * pSettings, RendererContext ** ppContext) { ::initRendererContext(appName, pSettings, ppContext); }
extern "C" void _1_exitRendererContext_(RendererContext * pContext) { ::exitRendererContext(pContext); }
extern "C" void _1_initRenderer_(const char * appName, const RendererDesc * pSettings, Renderer ** ppRenderer) { ::initRenderer(appName, pSettings, ppRenderer); }
...
extern "C" const void* _1_getSupportedSwapchainFormat_ = (void*)& ::getSupportedSwapchainFormat;
extern "C" const void* _1_getRecommendedSwapchainImageCount_ = (void*)& ::getRecommendedSwapchainImageCount;
