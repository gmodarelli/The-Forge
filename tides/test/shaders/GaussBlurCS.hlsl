...
void main(uint3 DTid : SV_DispatchThreadID)
{
	...
	const int radius = int(ceil(sqrt(-2.0 * g_blur_data.sigma * g_blur_data.sigma * log(1.0 - g_blur_data.support))));
	...
	{
		float kernel = IntegrateGaussian(index, g_blur_data.sigma);
